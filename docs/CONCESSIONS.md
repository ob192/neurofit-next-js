...
it 1200×630. It is neither: the file is 1408×768, and despite the extension it
is a JPEG. (It is still the hero image and still named `.png`. Next's image
pipeline sniffs the content, so nothing is broken by it — but don't trust the
extension.)
