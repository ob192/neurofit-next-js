...
import styles from './AltegioBookingSection.module.css';
...
/**
 * **Dormant.** The Altegio-backed booking section, kept intact but no longer
 * rendered: the studio moved booking to a Telegram bot, and `BookingSection.tsx`
 * next to this file is what the page mounts now. Nothing imports this module —
 * it is retained so the calendar can be brought back without archaeology. See
 * `docs/TELEGRAM_BOOKING.md` for how to restore it.
 *
 ...
 */
export async function AltegioBookingSection({ preselectedService }: BookingSectionProps) {
