...
export const faqItems: readonly FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      'Саме EMS-тренування триває 30 хвилин. Разом із підготовкою, вдяганням костюма та розтяжкою варто закласти близько години. Заняття зі стретчингу триває 1 годину.',
    drafted: true,
  },
  {
    id: 'beginners',
